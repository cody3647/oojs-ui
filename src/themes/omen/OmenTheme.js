 ...
 * @constructor
 */
OO.ui.OmenTheme = function OoUiWikimediaUITheme() {
	// Parent constructor
	OO.ui.OmenTheme.super.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.OmenTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.OmenTheme.prototype.getElementClasses = function ( element ) {
	// Parent method
	var variant, isFramed, isActive, isToolOrGroup,
		...
		// Parent method
		classes = OO.ui.OmenTheme.super.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.OmenTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.OmenTheme();
